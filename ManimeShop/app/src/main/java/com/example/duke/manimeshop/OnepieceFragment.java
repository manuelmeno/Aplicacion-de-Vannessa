 ...
 * {@link OnepieceFragment.OnFragmentInteractionListener} interface
...
public class OnepieceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista=inflater.inflate(R.layout.fragment_onepiece, container, false);
        com=(Button)vista.findViewById(R.id.comprar4);
        reg=(Button)vista.findViewById(R.id.regresar4);
